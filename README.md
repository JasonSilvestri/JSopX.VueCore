...
The `JSopX.WebAPI` Project requires at least the following technologies to run as expected.
...
There are additional project resources from the [jSilvestri.com BETA v 2024 JSopX™ Open ProjectX Collection](https://github.com/JasonSilvestri/JSopX.OpenProjectX.git) that required in order for the The `JSopX.WebAPI` Project to run as expected. 
...
2. **Open the solution in Visual Studio**:
    ...
    - Open `JSopX.WebAPI.sln` in Visual Studio.
